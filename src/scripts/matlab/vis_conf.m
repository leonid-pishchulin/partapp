...
function vis_conf(log_dir, varargin)
  ...
  [rootidx, figidx] = process_options(varargin, 'rootidx', -1, 'figidx', 1);
...
%          end
          ...
          plot([parent_pos(1), joint_pos(1), child_pos(1)], [parent_pos(2), joint_pos(2), child_pos(2)], 'b-', 'LineWidth', 3);
          hold on;
          %plot([parent_pos(1), child_pos(1)], [parent_pos(2), child_pos(2)], 'b.', 'LineWidth', 1, 'MarkerSize', 10);
          plot([parent_pos(1), child_pos(1)], [parent_pos(2), child_pos(2)], 'b.', 'MarkerSize', 30);
